...
function startOver() {
   switch (true) {
      case gamePattern.length > 0 && userClickedPattern.length > 0:
         gamePattern.length = 0; // Clear the game pattern array
         userClickedPattern.length = 0; // Clear the user clicked pattern array
